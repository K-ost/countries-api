...
`;
const Input = styled.input.attrs({ type: "search", "aria-label": "search" })<{
  $theme: ThemeType;
}>`
  background-color: var(--color-header);
  background-image: url(${(props) =>
    props.$theme === "dark" ? searchIcon : searchIconDark});
  ...
  &::-webkit-search-cancel-button {
    background: url(${(props) => (props.$theme === "dark" ? close : closeDark)})
